...
inline std::size_t TextureView::get_id() const {
  return id;
}

inline math::Vec3f TextureView::get_pos() const {
  return pos;
}
...
inline int TextureView::get_width() const {
  return width;
}

inline int TextureView::get_height() const {
  return height;
}

inline int TextureView::get_channels() const {
  return channels;
}
...
inline bool TextureView::inside(
    math::Vec3f const& v1,
    math::Vec3f const& v2,
    math::Vec3f const& v3) const {
