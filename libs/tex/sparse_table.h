...
public:
  ...
  static void save_to_file(
      SparseTable const& sparse_table,
...
template <typename C, typename R, typename T>
void SparseTable<C, R, T>::save_to_file(
    SparseTable const& sparse_table,
...
template <typename C, typename R, typename T>
void SparseTable<C, R, T>::load_from_file(
    const std::string& filename,
  ...
  if (version != VERSION) {
    in.close();
    throw util::FileException(
        filename, "Incompatible version of SparseTable file!");
  }
